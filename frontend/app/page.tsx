...
export default function Home() {
  ...
  const marketingContent = (
    <>
      {/* Nav — only needed when logged out; Sidebar covers nav once logged in */}
      {!loggedIn && (
      ...
      {/* Hero + Features share one background image */}
      <div className="relative overflow-hidden">
        {/* eslint-disable-next-line @next/next/no-img-element -- static decorative background, next/image not needed */}
        <img
          src="/hero-bg.png"
          alt=""
        ...
        {/* Hero */}
        <section className="relative px-8 pt-36 pb-24">
          <div className="max-w-5xl mx-auto">
            <div className="max-w-xl text-center md:text-left mx-auto md:mx-0">
              ...
              <h1 className="text-6xl font-bold leading-tight tracking-tight mb-6">
                ...
                <span className="text-stone-900">what you read.</span>
              </h1>
              <p className="text-lg text-stone-500 leading-relaxed max-w-md mx-auto md:mx-0 mb-10">
  ...
  if (loggedIn) {
    return (
      <div className="flex min-h-screen bg-white">
        ...
        />
        <div className="flex-1 min-w-0">{marketingContent}</div>
      </div>
    )
  }

  return <div className="min-h-screen bg-white">{marketingContent}</div>
}
